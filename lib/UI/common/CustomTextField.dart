...
//  final String initialText;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        width: width,
        margin: EdgeInsets.only(left: leftPadding, right: rightPadding, top: 2.0, bottom: 2.0),
        height: height,
        child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                filled: true,
                fillColor: color ?? Colors.grey[50],
                prefixIcon: prefixIcon ?? null,
                suffixIcon: suffixIcon ?? null,
                suffixIconConstraints:
                    BoxConstraints(maxHeight: 20, maxWidth: 40),
                labelText: label,
                labelStyle: TextStyle(fontSize: labelSize,color: Color(0xffC8C8C8),),
